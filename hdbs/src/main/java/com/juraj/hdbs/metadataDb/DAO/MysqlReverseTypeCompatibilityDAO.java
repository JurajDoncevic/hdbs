...
/** Data access class used to manage data type compatibilities for a MySQL database stored in a metadata database
 * @author Juraj
 */
public class MysqlReverseTypeCompatibilityDAO {
     ...
     */
    public MysqlReverseTypeCompatibilityDAO(String connectionUrl){
    ...
    public boolean insertCompatibility(String typeName1, String typeName2){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("INSERT INTO mysql_reverse_type_compatibility(type_name1, type_name2) VALUES('%s', '%s');", typeName1, typeName2));
    ...
    public boolean deleteCompatibility(String typeName1, String typeName2){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("DELETE FROM mysql_reverse_type_compatibility WHERE type_name1 = '%s' AND type_name2 = '%s' OR type_name1 = '%s' AND type_name2 = '%s';", typeName1, typeName2, typeName2, typeName1));

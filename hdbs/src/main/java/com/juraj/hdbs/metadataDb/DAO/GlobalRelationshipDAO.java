...
/** Data access class used to manage global relationships in the metadata database
 * @author Juraj
 */
public class GlobalRelationshipDAO {
     ...
     */
    public GlobalRelationshipDAO(String connectionUrl){

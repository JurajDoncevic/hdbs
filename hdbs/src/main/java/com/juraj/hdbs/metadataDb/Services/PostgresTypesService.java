...
/** Service class used to manage recognized data types for a PostgreSQL database in a metadata database
 * @author Juraj
 */
public class PostgresTypesService {
     ...
     */
    public PostgresTypesService(String connectionUrl){
    ...
    public List<String> getAllTypes(){
        ...
        try {
            ...
            statement.execute("SELECT type_name FROM 'pg_types';");
    ...
    public String getType(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("SELECT type_name FROM pg_types WHERE type_name = '%s';",  typeName));
    ...
    public boolean insertType(String typeName, boolean aggregationAllowed){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("INSERT INTO pg_types(type_name, aggregation_allowed) VALUES('%s', %s);", typeName, aggregationAllowed));
    ...
    public boolean deleteType(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("DELETE FROM pg_types WHERE type_name = '%s';", typeName));
    ...
    public boolean isAggregationAllowed(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("SELECT aggregation_allowed FROM pg_types WHERE type_name = '%s';",  typeName));
    ...
    public List<String> getAggregationAllowedTypes(){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("SELECT type_name FROM pg_types WHERE aggregation_allowed = %s;",  1));

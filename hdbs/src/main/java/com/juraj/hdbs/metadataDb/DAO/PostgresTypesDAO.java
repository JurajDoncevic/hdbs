...
/** Data access class used to manage recognized data types for a PostgreSQL database in a metadata database
 * @author Juraj
 */
public class PostgresTypesDAO {
     ...
     */
    public PostgresTypesDAO(String connectionUrl){
    ...
    public List<String> getAllTypes(){
        ...
        try {
            ...
            statement.execute("SELECT name FROM 'pg_types';");
    ...
    public String getType(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("SELECT name FROM pg_types WHERE name = '%s';",  typeName));
    ...
    public boolean insertType(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("INSERT INTO pg_types VALUES('%s');", typeName));
    ...
    public boolean deleteType(String typeName){
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            statement.execute(String.format("DELETE FROM pg_types WHERE name = '%s';", typeName));

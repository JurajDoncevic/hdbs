...
/** Service class used to manage data type compatibilities for a PostgreSQL and MySQL database stored in a metadata database
 */
public class PostgresMysqlTypeCompatibilityService {
     ...
     */
    public PostgresMysqlTypeCompatibilityService(String connectionUrl){
    ...
    public PostgresMysqlTypeCompatibilityModel getCompatibility(String postgresType, String mysqlType){
        ...
        try {
            ...
            String query = String.format("SELECT pg_type_name, mysql_type_name FROM pg_mysql_type_compatibility WHERE pg_type_name = '%s' AND mysql_type_name = '%s';", postgresType, mysqlType);
